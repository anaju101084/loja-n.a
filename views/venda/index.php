                    ...
                    <table class="table table-hover">
                        ...
                        <?php foreach($dao->read() as $venda) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit.php?id=<?= $venda->getIdvenda() ?>" title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a class="link link-danger" href="destroy.php?id=<?= $venda->getIdvenda() ?>" title="Excluir">
