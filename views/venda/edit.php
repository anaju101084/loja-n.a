                ...
                <div class="my-4">
                    ...
                    <form action="update.php" method="post">
                        <p class="form-group">
                            ...
                            <input type="text" name="preco" class="form-control" value="<?= $venda->getPreco() ?>">
                        </p>
                        <p class="form-group">
                            <label for="data">Data</label>
                            <input type="text" name="data" class="form-control" value="<?= $venda->getData() ?>">
                        </p>
                        ...
                        <p class="form-group">
                            ...
                            <select name="cliente" class="form-control">
                                <?php foreach($daoCliente->read() as $cliente) : ?>
                                    <?php if($cliente->getIdCliente() == $venda->getCliente()->getCliente_idcliente()) : ?>
                                        <option selected value="<?= $cliente->getCliente_idcliente() ?>"><?= $cliente->getNome() ?></option>
                                        <option selected value="<?= $cliente->getCliente_idcliente() ?>"><?= $cliente->getEmail() ?></option>
                                        <option selected value="<?= $cliente->getCliente_idcliente() ?>"><?= $cliente->getTelefone() ?></option>
                                    <?php else : ?>
                                        <option value="<?= $cliente->getCliente_idcliente() ?>"><?= $cliente->getNome() ?></option>
                                        <option value="<?= $cliente->getCliente_idcliente() ?>"><?= $cliente->getEmail() ?></option>
                                        <option value="<?= $cliente->getCliente_idcliente() ?>"><?= $cliente->getTelefone() ?></option>
                                    <?php endif ?>
                                <?php endforeach ?>
                            </select>
                        ...
                        <p class="form-group">
                            ...
                            <select name="forma_pagamento" class="form-control">
                                <?php foreach($daoForma_pagamento->read() as $forma_pagamento) : ?>
                                    <?php if($forma_pagamento->getforma_pagamento_idforma_pagamento() == $venda->getForma_Pagamento()->getforma_pagamento_idforma_pagamento()) : ?>
                                        <option selected value="<?= $forma_pagamento->getforma_pagamento_idforma_pagamento() ?>"><?= $forma_pagamento->getDescricao() ?></option>
                                    <?php else : ?>
                                        <option value="<?= $forma_pagamento->getforma_pagamento_idforma_pagamento() ?>"><?= $forma_pagamento->getDescricao() ?></option>
                                    <?php endif ?>
                                <?php endforeach ?>
                            </select>
                        <p><input type="hidden" name="id" value="<?= $_GET['id'] ?>"></p>
